...
function receivedMessage(event) {
    ...
    if (messageText) {
        ...
        switch (messageText) {
            ...
            default:
                sendTextMessage(senderID, AnalyseText(messageText));
        }
...
//this is a test function to analyse the received message and to search for some speical characters
function AnalyseText(messageText) {
